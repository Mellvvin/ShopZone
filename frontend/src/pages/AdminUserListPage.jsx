...
const AdminUserListPage = () => {
    ...
    const deleteHandler = async () => {
        try {
            ...
            setSuccessMsg(`${deleteName} has been removed.`);
    ...
    const updateRoleHandler = async () => {
        try {
            ...
            setSuccessMsg(`${selectedUser.name}'s role has been updated.`);
            ...
            >
                ...
                <Modal.Body>
                    ...
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
                        ...
                        Their orders will remain in the system.
                    </p>
                </Modal.Body>
                <Modal.Footer>
                    <Button
                        ...
                        {users.map((user, index) => (
                            <tr
                                ...
                                style={{
                                    ...
                                    opacity: user._id === userInfo._id ? 0.7 : 1,
                                }}
                            >
                                {/* ID */}
                                <td style={{
